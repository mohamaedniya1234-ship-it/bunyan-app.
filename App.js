...
const FLASHCARDS = [
  {
    id: 1,
    base: { pronunciation: 'مان', english: 'Man', arabic: 'رجل', badgeColor: '#00897B' },
    phrasal: { pronunciation: 'مان أَب', english: 'Man up', arabic: 'استرجل / تشجع', badgeColor: '#E53935' }
  },
  {
    id: 2,
    base: { pronunciation: 'باك', english: 'Back', arabic: 'ظهر / خلف', badgeColor: '#00897B' },
    phrasal: { pronunciation: 'باك أَب', english: 'Back up', arabic: 'يدعم / نسخ احتياطي', badgeColor: '#E53935' }
  },
  {
    id: 3,
    base: { pronunciation: 'شات', english: 'Shut', arabic: 'يغلق', badgeColor: '#00897B' },
    phrasal: { pronunciation: 'شات أَب', english: 'Shut up', arabic: 'اخرس / اصمت', badgeColor: '#E53935' }
  }
];
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        {activeTab === 'stats' && (
          <View style={styles.centerScreen}>
            ...
            <Text style={styles.screenSub}>الكلمات المتقنة: 142 | دقائق التحدث: {dailyProgressMinutes} دقيقة</Text>
          </View>
        )}
      ...
      <Modal visible={isCallActive} animationType="slide">
        <View style={styles.callScreenContainer}>
          ...
          <View style={styles.callControls}>
            <TouchableOpacity style={styles.controlBtnSecondary} onPress={() => setAiResponseText('ممتاز! حاول أن تنطق العبارة بثقة.')}>
          ...
          <ScrollView contentContainerStyle={styles.cardVisualContainer}>
            ...
            <View style={styles.phraseCard}>
              ...
              <View style={[styles.englishBadge, { backgroundColor: FLASHCARDS[currentCardIndex].phrasal.badgeColor }]}>
                <Text style={styles.englishBadgeText}>{FLASHCARDS[currentCardIndex].phrasal.english}</Text>
              </View>
...
const styles = StyleSheet.create({
  ...
  englishBadgeText: { color: '#FFFFFF', fontSize: 24, fontWeight: 'bold' },
  arabicTranslationText: { fontSize: 20, fontWeight: '600', color: '#94A3B8', marginTop: 6 },
  dividerLine: { height: 1, backgroundColor: '#334155', width: '80%', marginVertical: 15 },
